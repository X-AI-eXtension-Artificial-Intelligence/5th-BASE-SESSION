...
#디코더에서 각 시점마다 가장 확률이 높은 단어를 선택 -> 다음 시점의 입력으로 사용
...
def get_ds(config):
    ds_raw = load_dataset('opus_books','{}-{}'.format(config['lang_src'], config['lang_tgt']),split='train')
